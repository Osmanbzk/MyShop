...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            basket.BasketItems.Add(new BasketItem() { ProductId = "2", Quanity = 1, BasketId = basket.Id });
            ...
            customers.Insert(new Customer() { Id = "1", Email = "osman22@gmail.com", ZipCode = "34250" });
            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("osman22@gmail.com", "Forms"), null);
